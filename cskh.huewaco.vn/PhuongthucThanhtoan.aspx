<%@ Page Title="" Language="C#" MasterPageFile="~/CSKH.Master" AutoEventWireup="true" CodeBehind="PhuongthucThanhtoan.aspx.cs" Inherits="cskh.huewaco.vn.PhuongthucThanhtoan" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"><script type="text/javascript" src="media/js/jquery.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <div class="TitPage" style="margin-left: 8px; margin-right: 8px">
        ...
        <span class="subNavLink">PHƯƠNG THỨC THANH TOÁN</span>
    </div>
     ...
     <div id="divCauHoi" runat="server" style="margin-left: 8px; margin-right: 8px; margin-top: 20px">
        <table>
            <tr style="vertical-align: top;"><td>
                    <asp:Label runat="server" ID="lblTieude" Font-Names="Arial" Font-Size="14px" ForeColor="#000000" />
                </td>
            </tr>
