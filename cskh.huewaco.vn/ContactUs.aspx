<%@ Page Title="" Language="C#" MasterPageFile="~/CSKH.Master" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="cskh.huewaco.vn.ContactUs" %>
...
<asp:Content ID="ctnMainPlace" ContentPlaceHolderID="ContentPlace" Runat="Server">
    ...
    <div class="TitPage" style="margin-left:8px; margin-right:8px">
        ...
        <span class="subNavLink">THÔNG TIN LIÊN HỆ</span>
    </div>
