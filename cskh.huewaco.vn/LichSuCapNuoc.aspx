<%@ Page Title="" Language="C#" MasterPageFile="~/CSKH.Master" AutoEventWireup="true" CodeBehind="LichSuCapNuoc.aspx.cs" Inherits="cskh.huewaco.vn.LichSuCapNuoc" %>
        ...
        <ContentTemplate>
            ...
            <div style="margin-left: 8px; margin-right: 8px; margin-top: 5px">
                <dx:ASPxGridView ID="grvLich" OnDataBound="grvLich_OnDataBound" ClientInstanceName="grvLich" EnableRowsCache="False" KeyFieldName="idkh" runat="server" Width="100%" AutoGenerateColumns="False" OnDataBinding="grvLich_DataBinding">
                    <Columns>
                        <dx:GridViewDataColumn Caption="Tên khách hàng" FieldName="tenkh" VisibleIndex="0" />
                        ...
                        <dx:GridViewDataColumn Caption="Tình trạng" FieldName="ttsd" VisibleIndex="3" />
                    </Columns>
                    <Styles>
